 ...
 */
let destroyer = Fighter(name: "Destroyer", health: 100)

print("La postion d'avant est \(destroyer.position)")
destroyer.mouveRight()
print("La postion d'est \(destroyer.position)")
/*:
