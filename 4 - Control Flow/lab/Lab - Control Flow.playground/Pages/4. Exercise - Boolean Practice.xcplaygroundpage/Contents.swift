...
/*:
 Imaginez que vous essayez de décider de marcher ou non. Vous décidez de faire une promenade s'il ne pleut pas ou s'il fait 82 degrés ou s'il fait plus chaud et plus ensoleillé. Créez une constante `isNiceWeather` égale à une expression qui se traduit par un booléen indiquant si le temps est suffisamment agréable pour que vous puissiez aller vous promener. Ecrivez une déclaration if qui indiquera "Je vais me promener!" s'il fait beau.
 */
let temp = 81
let isRaining = true
let isSunny = true
